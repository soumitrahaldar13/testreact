          ...
          <div className="body-form">
           <form>
              <div className="input-group mb-3">
               ...
               <input type="text" className="form-control" placeholder="Username" style={{padding:"10px"}}/>
             </div>
            <div className="input-group mb-3 margin">
              <div className="input-group-prepend">
                <span className="input-group-text"><i class="fa fa-lock"></i></span>
              </div>
              <input type="text" className="form-control" placeholder="Password" style={{padding:"10px"}}/>
            </div>
 <button type="button" className="btn btn-secondary btn-block">LOGIN</button>
